...
def contests(request):
    return render(request, 'contest_templates/contests.html')
...
def blank_page(request):
    return render(request, 'myapp/blank_page.html', {})
...
def submit_file(request):
    ...
    return render(request, 'contest_templates/contest_detail.html', context)
...
def contests_view(request):
    ...
    return render(request, 'contest_templates/contests.html', context)
...
@login_required
@Policies.contest_results_access_politic(redirect_path='/contests/')
def contest_detail_results(request, contest_id):
    ...
    return render(request, 'contest_templates/contest_detail_results.html', context)
...
def contest_detail_submissions(request, contest_id):
    ...
    return render(request, 'contest_templates/contest_detail_submissions.html', context)
...
def contest_detail_view_admin_checker(request, contest_id):
    ...
    if request.method == 'POST':
        ...
        if form_code.is_valid():
            ...
            return render(request, 'contest_templates/contest_detail_admin_checker.html', context)
        else:
...
@Policies.contest_user_access_politic(redirect_path='/contests/')
@Policies.contest_preview_time_access_politic(redirect_path='/contests/')
...
def contest_participants_admin(request, contest_id):
    ...
    return render(request, 'contest_templates/contest_participants_admin.html', context)
